...
category: "2022 home art computational"
...
![](/assets/images/jitter/jitter1.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter2.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter3.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter4.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter5.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter6.jpg){:class="image-wide"}
</div>
<div class="masonry-column" markdown="1">
![](/assets/images/jitter/jitter7.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter8.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter9.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter10.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter11.jpg){:class="image-wide"}
![](/assets/images/jitter/jitter12.jpg){:class="image-wide"}
</div>
</div>
